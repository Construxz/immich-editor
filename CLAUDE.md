...
- Doku-Sprache wird Englisch (D-15); bis zur Übersetzung in M2 bleibt sie einheitlich Deutsch.
  Jede Doku-Datei (STATUS, ROADMAP, DECISIONS, LICENSES, Spec) hat daneben eine englische
  Fassung (`*.en.md`, D-84): Wer die deutsche ändert, zieht die englische im selben Commit nach
  (DECISIONS gestrafft).
  README englisch.
